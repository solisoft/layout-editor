...
(function ($) {
  $.trumbowyg.svgPath =
    "https://cdnjs.cloudflare.com/ajax/libs/Trumbowyg/2.21.0/ui/icons.svg";
  $.fn.contentEditor = function (options) {
    ...
    var get_widget_html = function (id, full) {
      ...
      switch (id) {
        case "h1":
          before =
            '<div class="sg-row cms_row" data-type="h1"><div class="' +
            settings.grid["col-12"] +
            ' cms_col">';
          html =
            '<h1 data-type="h1" class="drag drop" data-editable="true">Macaroon donut tiramisu sweet roll.</h1>';
          after = "</div></div>";
          break;
        case "h2":
          before =
            '<div class="sg-row cms_row" data-type="h2"><div class="' +
            settings.grid["col-12"] +
            ' cms_col">';
          html =
            '<h2 data-type="h2" class="drag drop" data-editable="true">Macaroon donut tiramisu sweet roll.</h2>';
          after = "</div></div>";
          break;
        case "h3":
          before =
            '<div class="sg-row cms_row" data-type="h3"><div class="' +
            settings.grid["col-12"] +
            ' cms_col">';
          html =
            '<h3 data-type="h3" class="drag drop" data-editable="true">Macaroon donut tiramisu sweet roll.</h3>';
          after = "</div></div>";
          break;
        case "h4":
          before =
            '<div class="sg-row cms_row" data-type="h4"><div class="' +
            settings.grid["col-12"] +
            ' cms_col">';
          html =
            '<h4 data-type="h4" class="drag drop" data-editable="true">Macaroon donut tiramisu sweet roll.</h4>';
          after = "</div></div>";
          break;
        case "h5":
          before =
            '<div class="sg-row cms_row" data-type="h5"><div class="' +
            settings.grid["col-12"] +
            ' cms_col">';
          html =
            '<h5 data-type="h5" class="drag drop" data-editable="true">Macaroon donut tiramisu sweet roll.</h5>';
          after = "</div></div>";
          break;
        case "h6":
          before =
            '<div class="sg-row cms_row" data-type="h6"><div class="' +
            settings.grid["col-12"] +
            ' cms_col">';
          html =
            '<h6 data-type="h6" class="drag drop" data-editable="true">Macaroon donut tiramisu sweet roll.</h6>';
          after = "</div></div>";
          break;
        case "img":
          before =
            '<div class="sg-row cms_row" data-type="img"><div class="' +
            settings.grid["col-12"] +
            ' cms_col">';
          html =
            '<div data-type="img" class="drag drop" data-editable="true"><img src="https://cms.fasty.ovh/asset/o/06650e1c-2579-463b-94fd-fc09655d3cd1?_from=Y21z" alt=""></div>';
          after = "</div></div>";
          break;
        case "text":
          before =
            '<div class="sg-row cms_row" data-type="text"><div class="' +
            settings.grid["col-12"] +
            ' cms_col">';
          html =
            '<div data-type="text" class="drag drop" data-editable="true"><p style="text-align: justify;">' +
            ipsum(5) +
            "</p></div>";
          after = "</div></div>";
          break;
        case "code":
          ...
          codes.push(
            '<code class="language-html">' +
              htmlEntities("<h1>Some html code</h1>") +
              "</code>",
          );
          codes.push(
            '<code class="language-javascript">console.log("JS ... really ? ")</code>',
          );
          codes.push('<code class="language-ruby">puts "I Love Ruby"</code>');
          before =
            '<div class="sg-row cms_row" data-type="code"><div class="' +
            settings.grid["col-12"] +
            ' cms_col">';
          html =
            '<div data-type="code" class="drag drop" data-editable="true"><pre>' +
            codes[loopid] +
            "</pre></div>";
          after = "</div></div>";
          break;
        case "video":
          ...
          data =
            '<div style="position:relative;padding-top:56.25%;"><iframe src="https://www.youtube.com/embed/' +
            ids[loopid] +
            '" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;"></iframe></div>';
          before =
            '<div class="sg-row cms_row" data-type="embed"><div class="' +
            settings.grid["col-12"] +
            ' cms_col">';
          html =
            '<div data-type="embed" class="drag drop" data-editable="true" data-html="' +
            data.replace(/"/g, "&quot;") +
            '">' +
            data +
            "</div>";
        ...
        case "col2":
          before = "";
          html =
            '<div class="sg-row cms_row sub_row drag" data-type="col2"><div class="' +
            settings.grid["col-6"] +
            ' cms_col"></div><div class="' +
            settings.grid["col-6"] +
            ' cms_col"></div></div>';
          after = "";
          break;
        case "col3":
          before = "";
          html =
            '<div class="sg-row cms_row sub_row drag" data-type="col3"><div class="col-4 cms_col"></div><div class="' +
            settings.grid["col-4"] +
            ' cms_col"></div><div class="' +
            settings.grid["col-4"] +
            ' cms_col"></div></div>';
        ...
        case "col4":
          before = "";
          html =
            '<div class="sg-row cms_row sub_row drag" data-type="col4"><div class="' +
            settings.grid["col-3"] +
            ' cms_col"></div><div class="' +
            settings.grid["col-3"] +
            ' cms_col"></div><div class="' +
        ...
        case "col282":
          before = "";
          html =
            '<div class="sg-row cms_row sub_row drag" data-type="col282"><div class="col-2 cms_col"></div><div class="' +
            settings.grid["col-8"] +
            ' cms_col"></div><div class="col-2 cms_col"></div><div class="' +
            settings.grid["col-3"] +
            ' cms_col"></div></div>';
          after = "";
          break;
        case "col363":
          before = "";
          html =
            '<div class="sg-row cms_row sub_row drag" data-type="col363"><div class="' +
            settings.grid["col-3"] +
            ' cms_col"></div><div class="' +
            settings.grid["col-6"] +
            ' cms_col"></div><div class="' +
        ...
        case "col48":
          before = "";
          html =
            '<div class="sg-row cms_row sub_row drag" data-type="col48"><div class="' +
            settings.grid["col-4"] +
            ' cms_col"></div><div class="' +
            settings.grid["col-8"] +
            ' cms_col"></div></div></div>';
        ...
        case "col84":
          before = "";
          html =
            '<div class="sg-row cms_row sub_row drag" data-type="col84"><div class="col-8 cms_col"></div><div class="' +
            settings.grid["col-4"] +
            ' cms_col"></div></div></div>';
          after = "";
          break;
        case "col10-2":
          before = "";
          html =
            '<div class="sg-row cms_row sub_row drag" data-type="col10-2"><div class="col-10 cms_col"></div><div class="' +
            settings.grid["col-2"] +
            ' cms_col"></div></div></div>';
          after = "";
          break;
        case "col2-10":
          before = "";
          html =
            '<div class="sg-row cms_row sub_row drag" data-type="col2-10"><div class="col-2 cms_col"></div><div class="' +
            settings.grid["col-10"] +
            ' cms_col"></div></div></div>';
          after = "";
          break;
      }
    ...
    */
    var set_windows_events = function () {
      window[self.attr("id") + "_drag"] = function (event) {
        var el = $(event.target).hasClass("drag")
          ? $(event.target)
      ...
      window[self.attr("id") + "_drop"] = function (event) {
        var subdomain =
          settings.subdomain || document.location.host.split(".")[0];
        event.stopPropagation();
        event.preventDefault();

        var el = $(event.target).hasClass("drop")
          ? $(event.target)
          : $(event.target).closest(".drop");
            ...
            if (event.dataTransfer.items[i].kind === "file") {
              ...
              if (
                ...
                reader.onloadend = function () {
                  ...
                  formData.append(
                    "key",
                    localStorage.getItem("resize_api_key"),
                  );

                  $.ajax({
                    headers: {
                      "X-Session-Id":
                        localStorage.getItem("X-Session-Id") ||
                        localStorage.getItem("X-SessionFront-Id"),
                    },
                    xhr: function () {
          ...
          if (!isFile) {
            ...
            if (dragObj.hasClass("cms_col")) {
              if (el.hasClass("cms_col")) {
                ...
                swap(
                  dragObj,
                  el.children().length == 0 ? el : el.children().first(),
                );
              }
            } else {
              if (el.hasClass("cms_col")) {
    ...
    */
    var add_drop_empty = function () {
      ...
      var empty =
        '<div class="sg-row cms_row" data-type="full"><div class="col-12 cms_col"><div class="drop drop_empty row_empty"></div></div></div>';
      var drop_empty =
        '<div class="drop drop_empty col_empty"><div></div></div>';

      $(self)
        .find(".edit-mode .cms_editor .sub_row .cms_col .drop")
        .each(function (i, el) {
          if (
            $(el).parent().hasClass("cms_col") ||
      ...
      $(self)
        .find(".edit-mode .page-content > .cms_row")
        .each(function (y, row) {
          $(row).before(empty);
        });
      $(self)
        .find(".edit-mode .cms_col")
        .each(function (y, col) {
          if (!$(col).hasClass("col-12")) $(col).prepend(drop_empty);
        });
      $(self).find(".edit-mode .cms_editor .page-content").append(empty);
      $(self)
        .find(".edit-mode .drop_empty")
        .attr(
          "ondragover",
          'window["' + self.attr("id") + '_allow_drop"](event)',
        );
      $(self)
        .find(".edit-mode .drop_empty")
        .attr("ondrop", 'window["' + self.attr("id") + '_drop"](event)');
    };
    ...
    var swap = function (from, to) {
      ...
      if ($(from).data("menuitem")) {
        ...
        if ($(to).hasClass("row_empty")) {
          var dest = $(html).hasClass("sub_row")
            ? $(parent).parent()
            : $(parent);
          ...
          if ($(to).hasClass("col_empty")) {
            ...
            if (!$(parent).hasClass("sg-container"))
              $(parent).html(html[0].outerHTML);
          }
        }
    ...
    var clear_empty_drags = function () {
      ...
      $(self)
        ...
        .each(function (i, el) {
          ...
          if (
            (!$(el).hasClass("cms_col") && $(el).html().trim() == "") ||
            $(el).html().trim() == "<div></div>"
          ) {
            $(el).remove();
          }
      ...
      $(base)
        ...
        .each(function (i, row) {
          if ($(row).data("type") == "full") {
            if ($(row).find("div:first").hasClass("cms_col"))
              $(row).data("type", $(row).find("[data-type]").data("type"));
    ...
    */
    var activate_events = function () {
      // Set the active Row
      $(self)
        .find(".edit-mode .cms_editor")
        .on("mouseenter", ".cms_row", function () {
          $(self)
            .find(".edit-mode .row_editor")
            .css("margin-left", -99999 + "px");
          var y =
            0 -
            $(self).find(".cms_editor").offset().top +
            $(this).offset().top +
            $(this).height() -
            $(self).find(".row_editor").height();
      ...
      $(self)
        .find(".edit-mode .cms_editor")
        .on("mouseenter", ".cms_col > *", function () {
      ...
      $(self)
        .find(".edit-mode .page-content")
        .on("click", "[data-type]", function () {
          editObj = $(this);
          raw_object = $(this.outerHTML);
          if (raw_object.data("attr")) {
            $(self)
              .find("input[data-name=col-class]")
              .val(raw_object.data("attr")["col-class"]);
            $(self)
              .find("input[data-name=row-class]")
              .val(raw_object.data("attr")["row-class"]);
            $(self)
              .find("input[data-name=container-class]")
              .val(raw_object.data("attr")["container-class"]);
          } else {
          ...
          if (raw_object.data("editable")) {
            ...
            if (
              ["embed", "h1", "h2", "h3", "h4", "h5", "h6"].indexOf(
                raw_object.data("type"),
              ) >= 0
            ) {
            ...
            if (["img"].indexOf(editObj.data("type")) >= 0) {
              var img_div =
                $(this).find(".img-div").length > 0
                  ? $(this).find(".img-div")
                  : $(this).find("img").parent();
              $(self).find(".editor-simplecode").show();
              $(self).find(".editor-img-code").show();
              $("#ace-editor-" + object_name).show();
              $(self)
                .find("input[data-name=img-width")
                .val(img_div.attr("data-img-width"));
              $(self)
                .find("select[data-name=img-alignment")
                .val(img_div[0].style["text-align"]);
              ace_editor.session.setMode("ace/mode/html");
              ace_editor.setOptions({
                maxLines: Infinity,
                tabSize: 2,
      ...
      $(self)
        ...
        .on("click", function (e) {
          ...
          $(self)
            ...
            .attr(
              "ondragstart",
              'window["' + self.attr("id") + '_drag"](event)',
            );
          $(self)
            .find(".edit-mode .drag")
            .attr(
          ...
          $(self)
            ...
            .attr(
              "ondragend",
              'window["' + self.attr("id") + '_drag_end"](event)',
            );
    ...
    */
    var remove_drag_attributes = function () {
      $(self)
        .find(".view-mode .drag, .view-mode .drop")
    ...
    var view_mode =
      '<a href="" class="toggle-layout view-mode isactive">\
                      ' +
      settings.texts.edit_content +
      "</a>";
    view_mode +=
      '<section class="view-mode isactive">\
                        <div class="page-content"></div></section>';

    $(self).append(view_mode);

    var items =
      '<aside class="edit-mode">\
                  <div class="sg-container toolbox"><h1>' +
      settings.texts.page_tools +
      '</h1> \
                  <div class="sg-row"></div>\
                  <div class="sg-row"><a href="" class="button save-layout">' +
      settings.texts.save +
      '</a></div>\
                  <div class="sg-row"><a href="" class="button toggle-layout">' +
      settings.texts.exit +
      "</a></div></div>\
                </aside>";
    ...
    settings.widgets.forEach(function (w) {
      $(self)
        .find(".toolbox .sg-row:first")
        .append(
          '\
      <div class="col-4 drag" dragdraggable="true" data-menuitem="' +
            w.id +
            '">\
        <a href="#" class="addwidget" data-id="' +
            w.id +
            '">\
          <i class="' +
            w.icon +
    ...
    var content =
      ...
      object_name +
      '"></div>\
            <div><label>Container Class</label><input type="text" data-name="container-class" class="' +
      settings.input +
      '"></div>\
            <div><label>Row Class</label><input type="text" data-name="row-class" class="' +
      settings.input +
      '"></div>\
            <div><label>Col Class</label><input type="text" data-name="col-class" class="' +
      settings.input +
      '"></div>\
            <div class="editor-code"><label>Language</label><input type="text" data-name="lang" class="' +
      settings.input +
      '"></div>\
            <div class="uk-grid"><div class="uk-width-1-2 editor-img-code"><label>Image Width</label><input type="text" data-name="img-width" class="' +
      settings.input +
      '"></div>\
            ...
            <div class="editor-code editor-simplecode"><label>Code</label><div id="ace-editor-' +
      object_name +
      '" class="ace-editor"></div></div>\
          </div>\
        </div>\
      </div>\
    ...
    $("#trumbowyg-" + object_name)
      .trumbowyg(settings.trumbowyg)
    ...
    var save_editor = function () {
      if (editObj) {
        ...
        if (
          ["h1", "h2", "h3", "h4", "h5", "h6"].indexOf(editObj.data("type")) >=
          0
        ) {
        ...
        if (["img"].indexOf(editObj.data("type")) >= 0) {
          var width = $(self).find("input[data-name=img-width").val()
            ? $(self).find("input[data-name=img-width").val()
            : "100%";
          var alignment = $(self).find("select[data-name=img-alignment").val()
            ? $(self).find("select[data-name=img-alignment").val()
            : "left";
          ...
          editObj.html(
            '<div class="img-div" style="text-align: ' +
              alignment +
              '" data-img-width="' +
              width +
              '">' +
